      ...
      <main className="max-w-[1600px] mx-auto px-6 py-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-10">
          <div>
            ...
            <p className="text-white">Gerenciamento de animais do sistema</p>
          </div>
            ...
            {pets.length === 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-8">
                {pets.map((pet) => (
                  <div 
                    key={pet.id} 
                    className="bg-surface rounded-xl border border-gray-800 overflow-hidden hover:border-primary/50 transition-colors group flex flex-col cursor-pointer"
